...
ubuntu@vps-3725c89d:~$ sudo find /etc -name postgresql.conf
/etc/postgresql/17/main/postgresql.conf
ubuntu@vps-3725c89d:~$ sudo nano /etc/postgresql/17/main/postgresql.conf
ubuntu@vps-3725c89d:~$ sudo cat /etc/postgresql/17/main/postgresql.conf
# -----------------------------
